...
- **[MCP](/webmcp-auto-ui/fr/concepts/mcp/)** : recupere les donnees que WebMCP affiche
- **[Tool Layers](/webmcp-auto-ui/fr/concepts/tool-layers/)** : les serveurs WebMCP produisent des `WebMcpLayer`
- **[Recettes](/webmcp-auto-ui/fr/concepts/recipes/)** : chaque serveur WebMCP embarque des recettes qui guident l'agent
- **[widget_display](/webmcp-auto-ui/fr/concepts/widget-display/)** : l'outil unifie qui dispatch vers le bon renderer WebMCP
- **[Widgets UI](/webmcp-auto-ui/fr/concepts/ui-widgets/)** : les composants Svelte qui rendent les widgets
