...
- [Package SDK](/webmcp-auto-ui/fr/packages/sdk/) -- `decodeHyperSkill`, `encodeHyperSkill`
- [Flex](/webmcp-auto-ui/fr/apps/flex/) -- pour editer avec l'agent IA
- [Recipes](/webmcp-auto-ui/fr/apps/recipes/) -- pour tester les recettes
