...
- [Package agent](/webmcp-auto-ui/fr/packages/agent/) -- `WEBMCP_RECIPES`, `recipeRegistry`
- [Flex](/webmcp-auto-ui/fr/apps/flex/) -- utilisation des recettes en contexte
- [Viewer](/webmcp-auto-ui/fr/apps/viewer/) -- pour consulter les skills generees
