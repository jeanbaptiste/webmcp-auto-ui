...
Pour piloter les outils via un agent LLM (au lieu du navigateur), voir l'architecture du [Boilerplate](/webmcp-auto-ui/fr/apps/boilerplate/) qui integre `runAgentLoop`.
...
- [Package core](/webmcp-auto-ui/fr/packages/core/) -- `jsonResult`
- [Package UI](/webmcp-auto-ui/fr/packages/ui/) -- composants utilises
- [Boilerplate](/webmcp-auto-ui/fr/apps/boilerplate/) -- version avec agent IA
