...
- [Package core](/webmcp-auto-ui/fr/packages/core/) -- `createWebMcpServer`
- [Package agent](/webmcp-auto-ui/fr/packages/agent/) -- `runAgentLoop`
- [Flex (app complete)](/webmcp-auto-ui/fr/apps/flex/) -- pour voir toutes les fonctionnalites avancees
