...
<video src="https://github.com/user-attachments/assets/689126f5-64d9-48dd-8ac4-defb3cbf37d4" controls muted loop playsinline style="width:100%;max-width:1280px;border-radius:8px;margin:1rem 0;">
  Votre navigateur ne supporte pas la balise video. <a href="/webmcp-auto-ui/demo.html">Voir le walkthrough anime</a>.
</video>

> 🎬 [Animated walkthrough (interactive HTML)](/demo.html) — MCP + WebMCP + HyperSkills, ~2 min

WebMCP Auto-UI est une plateforme de generation automatique d'interfaces utilisateur pilotees par des agents IA. Elle combine le **Model Context Protocol (MCP)** pour l'integration de donnees, un **moteur d'agents LLM** pour l'orchestration, et un **systeme de widgets declaratifs ([WebMCP](/webmcp-auto-ui/fr/concepts/webmcp/))** pour le rendu cote client.
