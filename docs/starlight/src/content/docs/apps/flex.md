...
| Icons | lucide-svelte |
| LLM providers | `RemoteLLMProvider` (remote LLM via proxy), `WasmProvider` (Gemma in-browser), `LocalLLMProvider` (Ollama) |
...
| `cacheEnabled` | Prompt cache (provider-dependent) | `true` |
...
- [Live demo](https://demos.hyperskills.net/flex/)
- [Agent package](/webmcp-auto-ui/packages/agent/)
- [Core package](/webmcp-auto-ui/packages/core/)
- [SDK package](/webmcp-auto-ui/packages/sdk/)
- [UI package](/webmcp-auto-ui/packages/ui/)
