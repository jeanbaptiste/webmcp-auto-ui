...
<video src="https://github.com/user-attachments/assets/689126f5-64d9-48dd-8ac4-defb3cbf37d4" controls muted loop playsinline style="width:100%;max-width:1280px;border-radius:8px;margin:1rem 0;">
  Your browser does not support the video tag. <a href="/webmcp-auto-ui/demo.html">View the animated walkthrough</a>.
</video>

> 🎬 [Animated walkthrough (interactive HTML)](/webmcp-auto-ui/demo.html) — MCP + WebMCP + HyperSkills, ~2 min

WebMCP Auto-UI is a platform for automatic user interface generation driven by AI agents. It brings together the **Model Context Protocol (MCP)** for data integration, an **LLM agent engine** for orchestration, and a **declarative widget system ([WebMCP](/webmcp-auto-ui/concepts/webmcp/))** for client-side rendering.
