...
- Name: smoke.spec.ts >> Showcase >> MCP input visible
- Location: tests/e2e/smoke.spec.ts:206:7
...
Locator: locator('input[placeholder*="MCP"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('input[placeholder*="MCP"]')
