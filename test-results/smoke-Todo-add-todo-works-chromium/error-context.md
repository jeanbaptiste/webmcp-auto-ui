...
- Name: smoke.spec.ts >> Todo >> add todo works
- Location: tests/e2e/smoke.spec.ts:334:7
...
Call log:
  - waiting for locator('input[placeholder*="tâche"], input[placeholder*="Nouvelle"]').first()
