...
- Name: smoke.spec.ts >> Composer >> MCP URL input is functional
- Location: tests/e2e/smoke.spec.ts:64:7
...
Locator: locator('input[placeholder*="mcp"]').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('input[placeholder*="mcp"]').first()
