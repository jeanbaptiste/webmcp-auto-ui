...
- Name: smoke.spec.ts >> Viewer >> loads with correct title
- Location: tests/e2e/smoke.spec.ts:139:7
...
```
Error: page.goto: net::ERR_NETWORK_CHANGED at https://demos.hyperskills.net/viewer/
Call log:
  - navigating to "https://demos.hyperskills.net/viewer/", waiting until "load"
