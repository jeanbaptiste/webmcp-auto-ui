...
- Name: smoke.spec.ts >> Todo >> loads successfully
- Location: tests/e2e/smoke.spec.ts:328:7
...
Locator: locator('input[placeholder*="tâche"], input[placeholder*="Nouvelle"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('input[placeholder*="tâche"], input[placeholder*="Nouvelle"]')
