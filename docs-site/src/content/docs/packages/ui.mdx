...
Selecteur de modele LLM avec support des modeles distants (Claude) et locaux (Gemma WASM).
...
Modeles affiches : `haiku`, `sonnet`, `opus` (Anthropic Claude), `gemma-e2b`, `gemma-e4b` (Google Gemma WASM).
