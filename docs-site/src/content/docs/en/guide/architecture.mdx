...
<img src="/diagrams/architecture-1.svg" alt="Overall architecture: Svelte 5 frontend, agentic loop and tool routing" />

## Detailed Agentic Loop

<img src="/diagrams/architecture-2.svg" alt="Detailed agentic loop sequence diagram" />
...
<img src="/diagrams/architecture-3.svg" alt="Canonical MCP tool resolution via 4-layer matching" />
...
<img src="/diagrams/architecture-4.svg" alt="Reactive canvas: vanilla store, Svelte 5 wrapper and agent callbacks" />
...
<img src="/diagrams/architecture-5.svg" alt="widget_display flow from validation to DOM mount" />
