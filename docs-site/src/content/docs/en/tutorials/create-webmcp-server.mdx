...
<img src="/diagrams/tut-webmcp-server-1.svg" alt="Full pipeline: component, recipe, WebMCP server, agent loop, LLM" />
...
<img src="/diagrams/tut-webmcp-server-2.svg" alt="Multi-server MCP and WebMCP architecture" />
...
<img src="/diagrams/tut-webmcp-server-3.svg" alt="Discovery and rendering sequence for a kanban widget" />

### The widget_display dispatch

<img src="/diagrams/tut-webmcp-server-4.svg" alt="widget_display dispatch with validation and rendering" />
