...
<img src="/webmcp-auto-ui/diagrams/tut-webmcp-server-1.svg" alt="Pipeline complet : composant, recette, serveur WebMCP, agent loop, LLM" />
...
<img src="/webmcp-auto-ui/diagrams/tut-webmcp-server-2.svg" alt="Architecture multi-serveurs MCP et WebMCP" />
...
<img src="/webmcp-auto-ui/diagrams/tut-webmcp-server-3.svg" alt="Sequence de decouverte et rendu d'un widget kanban" />

### Le dispatch widget_display

<img src="/webmcp-auto-ui/diagrams/tut-webmcp-server-4.svg" alt="Dispatch widget_display avec validation et rendu" />
