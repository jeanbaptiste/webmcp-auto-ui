...
<img src="/diagrams/tut-arch-mcp-1.svg" alt="Comparaison MCP (donnees distantes) et WebMCP (affichage local)" />
...
<img src="/diagrams/tut-arch-mcp-2.svg" alt="Symetrie du routage : MCP via HTTP, WebMCP via JS local" />
...
<img src="/diagrams/tut-arch-mcp-3.svg" alt="Lazy loading : discovery puis activation des outils MCP" />
...
<img src="/diagrams/tut-arch-mcp-4.svg" alt="Pipeline des schemas : composant Svelte vers WebMCP Server" />
...
<img src="/diagrams/tut-arch-mcp-5.svg" alt="Validation JSON Schema au runtime avant rendu du widget" />
...
<img src="/diagrams/tut-arch-mcp-6.svg" alt="Flow complet d'une conversation : discovery, data, schema, display" />
...
<img src="/diagrams/tut-arch-mcp-7.svg" alt="Multi-serveurs : agent loop avec MCP et WebMCP layers" />
...
<img src="/diagrams/tut-arch-mcp-8.svg" alt="Architecture globale : navigateur (app, agent, widgets) et serveurs distants" />
