...
- [Package core](/packages/core/) -- `createWebMcpServer`
- [Package agent](/packages/agent/) -- `runAgentLoop`
- [Flex (app complete)](/apps/flex2/) -- pour voir toutes les fonctionnalites avancees
