...
| Chemin sur le serveur | `/opt/webmcp-demos/viewer2/build/` (sous-dossier) |
|----------------------|---------------------------------------------------|
| Service systemd | `webmcp-viewer2` |
