...
1. **L'agent LLM** (Claude ou Gemma) recoit un prompt utilisateur et decide quels outils appeler.
...
- **Agents autonomes** : Boucle agentic native avec support pour Claude (API), Gemma 4 (LiteRT in-browser) et Ollama (local)
