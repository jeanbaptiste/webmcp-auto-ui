...
Une cle API (`ANTHROPIC_API_KEY`) n'est necessaire que pour les LLM distants (e.g. Claude, Gemini, ChatGPT). L'agent Gemma 4 tourne entierement dans le navigateur, sans cle ni serveur distant.
:::
