...
## Example
```
rough_webmcp_widget_display({name: "rough-treemap", params: {items: [{label: "JavaScript", value: 40}, {label: "Python", value: 30}, {label: "TypeScript", value: 20}, {label: "Rust", value: 10}], title: "Language Popularity"}})
```
