...
## Example
```
rough_webmcp_widget_display({name: "rough-slope-chart", params: {items: [{label: "Product A", start: 40, end: 65}, {label: "Product B", start: 55, end: 45}, {label: "Product C", start: 30, end: 50}], startLabel: "2023", endLabel: "2024", title: "Year-over-Year Change"}})
```
