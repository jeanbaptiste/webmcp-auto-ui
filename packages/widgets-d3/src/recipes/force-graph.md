...
## When to use
For relationship networks (social graphs, dependency trees, knowledge graphs, entity relationships). Nodes are pulled together by links and pushed apart by charge.
...
- If `label` is omitted, `id` is displayed instead
